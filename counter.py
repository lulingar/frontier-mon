#!/usr/bin/env python
"""
  Implements the Counter class found in Python 2.7+ collections
  Taken from: http://code.activestate.com/recipes/259174/
"""
...
class Counter (object):
    ...
    # Work around __len__ limitation to values < 2**31
    def count(self):
        assert self._len == sum(self._data.itervalues())
        return self._len
